...
Usage:
  python3 scripts/railway/rebuild-japan-package-geometry.py
"""
...
# NOTE: polyline_km stays local — Japan sums unrounded segment lengths and
# rounds once, while lib.geometry.polyline_km rounds per segment (the Hong
# Kong / Macao convention). See lib/geometry.py's docstring.
from lib.geometry import dedupe, metres
