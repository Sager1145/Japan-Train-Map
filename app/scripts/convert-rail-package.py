...
Usage:
  python3 scripts/convert-rail-package.py [path]            # -> compact-v1 (default path: public/rail/jp-2025.json)
  python3 scripts/convert-rail-package.py --expand [path]   # compact-v1 -> legacy flat (debugging)
