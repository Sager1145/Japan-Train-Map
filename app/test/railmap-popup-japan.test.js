...
test("only audited Japanese line badges stay ahead of operator fallbacks", () => {
  ...
  // 387/322, up from 349/284 with the 2026-08-15 rebuild and the 2026-08-17
  ...
  assert.equal(packageImages.length, 387);
  assert.equal(linesWithBadges.length, 322);
...
test("every non-line image falls back to the exact operator, never a parent or predecessor", () => {
  ...
  // 334/327, moved by the 2026-08-15 rebuild and the 2026-08-17 paired alignments. The rule is
